...
export default function CreateListing() {
    ...
    async function onSubmit(e){
        ...
        if(geolocationEnabled){
            ...
            try {
                const response = await fetch(`https://geocode.maps.co/search?q=${address}&api_key=${process.env.REACT_APP_API_KEY}`);
                ...
                console.log("couldn't fetch data from geolocation api");
            }
        }else{
        ...
        <form onSubmit={onSubmit}>
            ...
            {!geolocationEnabled && (
                <div className='flex space-x-6 justify-start mb-6'>
                    <div>
                        ...
                        <input className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:text-gray-700 focus:border-slate-600 text-center' type='number' id='latitude' value={latitude} onChange={onChange} required min="-90" max="90" />
                    </div>

                    <div className='space-x-6 justify-start'>
                        <p className='text-lg font-semibold'>Longitude</p>
                        <input className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:text-gray-700 focus:border-slate-600 text-center' type='number' id='longitude' value={longitude} onChange={onChange} required min="-180" max="180" />
                    </div>
                </div>
            )}
            ...
            <div className='flex items-center mb-6'>
                <div>
                    ...
                    <div className='flex w-full justify-center items-center space-x-6'>
                        <input type='number' id='regularPrice' value={regularPrice} onChange={onChange} min="50" max="40000000000" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center' />
            ...
            {offer && (
                ...
                <div>
                    ...
                    <div className='flex w-full justify-center items-center space-x-6'>
                        <input type='number' id='DiscountedPrice' value={regularPrice} onChange={onChange} min="50" max="40000000000" required={offer} className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center' />
